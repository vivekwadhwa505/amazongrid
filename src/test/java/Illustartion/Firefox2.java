...
public class Firefox2 {
  @Test
	  ...
	  public void authenticate6() throws MalformedURLException, URISyntaxException, Exception {
		  DesiredCapabilities few=new DesiredCapabilities();
			few.setBrowserName("firefox");

			FirefoxOptions step = new FirefoxOptions();
			step.merge(few);

			String x = "http://192.168.29.57:4444";
			WebDriver driver = new RemoteWebDriver(new URI(x).toURL(), step);

			driver.get("https://www.amazon.in");
			System.out.println("firefox getting launched");
